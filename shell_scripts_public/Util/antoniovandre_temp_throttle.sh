...
# version 2.21 (modificada por Antonio Vandré Pedrosa Furtunato Gomes)
...
# Início Antonio Vandré modificação.

MAX_TEMP="75"

date > /home/antoniovandre/Temp/antoniovandre_latest_pos_antoniovandre_temp_throttle

# Fim Antonio Vandré modificação.
