...
int main (int argc, char *argv [])
	...
	if ((argc == 4) && (flag == NUMEROZERO)) {antoniovandre_copiarstring (arquivo_math_estatisticas, argv [3]); if (! antoniovandre_salvarmathestatisticas (CABECALHO_ESTATISTICAS_MATHEVAL)) return NUMEROMENOSUM;}
